...
use App\Http\Controllers\Frontend\SiteNoteController;
...
// })->name('home');
Route::post('/note/store', [SiteNoteController::class, 'store'])->name('frontend.notes_store');
...
Route::controller(PageController::class)->group(function () {
    ...
    Route::get('/brand', 'brand')->name('frontend.brand');
...
Route::controller(EventController::class)->group(function () {
    Route::get('/events', 'index')->name('frontend.event.index');
    Route::get('/events/{slug}', 'show')->name('frontend.event.show');
});
/**
 * ::::::::::::::  Ajax Routes End ::::::::::::::
 */
