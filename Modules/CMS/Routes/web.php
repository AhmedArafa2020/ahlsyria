...
use Modules\CMS\Http\Controllers\FaqController;
...
Route::prefix('admin')->middleware(['auth.routes'])->group(function () {
    ...
    Route::controller(FaqController::class)->prefix('faq')->group(function () {
        Route::get('/', 'index')->name('admin.faq.index')->middleware('PermissionCheck:testimonial_read');
        Route::get('/create', 'create')->name('admin.faq.create')->middleware('PermissionCheck:testimonial_create');
        Route::post('/store', 'store')->name('admin.faq.store')->middleware('PermissionCheck:testimonial_store');
        Route::get('/edit/{id}', 'edit')->name('admin.faq.edit')->middleware('PermissionCheck:testimonial_update');
        Route::post('/update/{id}', 'update')->name('admin.faq.update')->middleware('PermissionCheck:testimonial_update');
        Route::get('/delete/{id}', 'destroy')->name('admin.faq.destroy')->middleware('PermissionCheck:testimonial_delete');
    });
