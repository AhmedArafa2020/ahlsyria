        ...
        <div class="table-content table-basic ecommerce-components product-list">
            <div class="card">
                <div class="card-body">
                    ...
                    <div
                        ...
                        @if (hasPermission('testimonial_create'))
                            <div class="align-self-center d-flex gap-2">
                                <!-- add btn -->
                                <div class="align-self-center">
                                    <a href="{{ route('admin.faq.create') }}" role="button" class="btn-add"
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody class="tbody">
                                ...
                                @forelse ($data['faqs'] as $key => $faq)
                                    <tr>
                                        <td>{{ @$faq->id }}</td>
                                        <td>{{ Str::limit(@$faq->title, 20) }}</td>
                                        <td>{{ Str::limit(@$faq->content, 200) }}</td>
                                        <td>
                                            {{ statusBackend(@$faq->status->class, $faq->status->name) }}
                                        </td>
                                                    ...
                                                    @if (hasPermission('testimonial_update'))
                                                        <li>
                                                            <a class="dropdown-item"
                                                                href="{{ route('admin.faq.edit', $faq->id) }}"><span
                                                                    class="icon mr-12"><i
                                                    ...
                                                    @if (hasPermission('testimonial_delete'))
                                                        <li>
                                                            <a class="dropdown-item delete_data" href="javascript:void(0);"
                                                                data-href="{{ route('admin.faq.destroy', $faq->id) }}">
                    ...
                    <!--  table end -->
                    <!--  pagination start -->
                    @include('backend.ui-components.pagination', ['data' => $data['faqs']])
                    <!--  pagination end -->
                </div>
            </div>
        </div>
