...
@section('content')
    <div class="page-content">
        ...
        <div class="card ot-card">
            ...
            <div class="card-body">
                <form action="{{ route('admin.faq.update', $data['faq']->id ) }}" enctype="multipart/form-data" method="post">
                    @csrf
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                        list="datalistOptions" id="title" value="{{  @$data['faq']->title }}"
                                ...
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <select class="form-select ot-input select2 @error('status_id') is-invalid @enderror"
                                        ...
                                        <option value="1" {{ @$data['faq']->status_id == 1 ? 'selected' : '' }} >{{ ___('common.Active') }}</option>
                                        <option value="2" {{ @$data['faq']->status_id == 2 ? 'selected' : '' }}>{{ ___('common.Inactive') }}</option>
                                    </select>
                                    @error('status_id')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-xl-12 col-md-12 mb-3">
                                    ...
                                    <textarea class="form-control ot-textarea @error('content') is-invalid @enderror" name="content" list="datalistOptions"
                                        rows="9" id="content" placeholder="{{ ___('placeholder.Enter Content') }}"><?= @$data['faq']->content ?></textarea>
                                    @error('content')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
