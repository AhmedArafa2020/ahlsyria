    ...
    public function run()
    {
        try {
            ...
            Setting::create([
                ...
                'value' => 'نحن هنا لنقدم للشباب المستقلين في سوريا فرصة للنمو والتطور عبر تجربة تعليمية مميزة ومحفزة. نؤمن بقوة بقدرتكم على تحقيق التفوق وتحويل الصعاب إلى فرص',
            ]);
            Setting::create([
                'name' => 'footer_text',
                'value' => '© ' . date('Y') . ' Ahl Syria . جميع الحقوق محفوظة.',
            ]);
            Setting::create([
                'name' => 'file_system',
                'value' => 'local',
