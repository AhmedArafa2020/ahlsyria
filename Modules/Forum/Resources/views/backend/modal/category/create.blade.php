                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-md-6 mb-3">
                            ...
                            <select class="form-select ot-input modal_select2 @error('filters') is-invalid @enderror"
                                ...
                                <option value="state_idlib">سكان منطقة ادلب</option>
                                <option value="state_aleppo">سكان منطقة حلب</option>
                                <option value="country_turkey">سكان تركيا</option>
                                <option value="country_syria">سكان سوريا</option>
                                <option value="work_field_web_programming">العاملين في مجال برمجة المواقع</option>
                                <option value="work_field_content_creator">العاملين في مجال صناعة المحتوى</option>
                                <option value="work_field_graphic_design">العاملين في مجال التصميم</option>
                                <option value="gender_1">الذكور</option>
                                <option value="gender_2">الإناث</option>
                            </select>
                        </div>
