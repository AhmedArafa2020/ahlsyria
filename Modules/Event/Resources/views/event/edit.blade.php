...
@section('content')
    <div class="event-content">
        ...
        <div class="card ot-card">
            <div class="card-body">
                <form action="{{ route('events.update', $data['event']->id) }}" enctype="multipart/form-data" method="post">
                    @csrf
                    @method('PUT')
                    {{-- Style Two --}}
                    <div class="row mb-3">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('title') is-invalid @enderror" name="title"
                                        ...
                                        value="{{ @$data['event']->title ?? old('title') }}">
                                    @error('title')
                                ...
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <input class="form-control ot-input @error('address') is-invalid @enderror" name="address"
                                        ...
                                        placeholder="{{ ___('placeholder.Enter Address') }}" value="{{ @$data['event']->address }}">
                                    @error('address')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-xl-12 col-md-12 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control ot-input" id="start_date" name="start_date"
                                        required placeholder="{{ ___('course.Start Date') }}" value="{{ @$data['event']->start_date }}" />
                                    @error('start_date')
                                ...
                                <div class="col-xl-12 col-md-12 mb-3">
                                    ...
                                    <input type="datetime-local" class="form-control ot-input" id="end_date" name="end_date"
                                        required placeholder="{{ ___('course.End Date') }}" value="{{ @$data['event']->end_date }}" />
                                    @error('end_date')
                                        <div id="validationServer04Feedback" class="invalid-feedback error-show">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-xl-6 col-md-6 mb-3">
                                    ...
                                    <select class="form-select ot-input select2 @error('status') is-invalid @enderror"
                                        ...
                                        <option @if (@$data['event']->status == 'active') {{ 'selected' }} @endif value="active">
                                            {{ ___('common.Active') }}</option>
                                        <option @if (@$data['event']->status == 'disabled') {{ 'selected' }} @endif
                                            value="disabled">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    ...
                                    <div @if (@$data['event']->image) data-val="{{ (showImage(@$data['event']->image->original)) }}" @endif
                                ...
                                <div class="col-xl-12 col-md-12 mb-3 custom-height">
                                    <label for="status" class="form-label ">وصف<span
                                            class="fillable">*</span></label>
                                    <textarea id="short_description" name="short_description" class="@error('short_description') is-invalid @enderror"><?= @$data['event']->short_description ?></textarea>
                                ...
                                <div class="col-xl-12 col-md-12 mb-3 event-type-content">
                                    ...
                                    <textarea class="form-control summernote @error('content') is-invalid @enderror" name="content" list="datalistOptions"
                                        rows="20" id="content" placeholder="{{ ___('placeholder.Enter Content') }}"><?= @$data['event']->content ?></textarea>
                                    @error('content')
                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                            {{ $message }}
                                        </div>
