                                            ...
                                            <div class="mb-24 border-0 pt-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-6 col-md-6 mb-3">
                                                        <label for="title" class="form-label ">{{ ___('course.Course
                                                            Title') }}
                                                    ...
                                                    {{-- start cert_title --}}
                                                    <div class="col-xl-6 col-md-6 mb-3">
                                                        <label for="cert_title" class="form-label ">
                                                            عنوان الكورس بالشهادة
                                                            <span class="fillable">*</span></label>
                                                        <input
                                                            class="form-control ot-input @error('cert_title') is-invalid @enderror"
                                                            name="cert_title" list="datalistOptions" id="cert_title"
                                                            value="{{ @$data['course']->cert_title }}"
                                                            placeholder="عنوان الكورس بالشهادة">
                                                        @error('cert_title')
                                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="col-xl-6 col-md-6 mb-3">
                                                        ...
                                                        <label for="instructor" class="form-label ">اسم المدرب
                                                            <span class="fillable"></span></label>
                                                        <input
                                                            class="form-control ot-input @error('instructor_name') is-invalid @enderror"
                                                            name="instructor_name" list="datalistOptions"
                                                            id="instructor_name"
                                                            value="{{ @$data['course']->instructor_name }}"
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="course_level" class="form-label ">{{
                                                            ___('course.Course Level') }}
                                                            <span class="fillable">*</span></label>
                                                        <select
                                                            ...
                                                            <option value="{{ $level->id }}" {{ @$data['course']->
                                                                level_id == $level->id ? ' selected="selected"' : '' }}>
                                                                {{ $level->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error('course_level')
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="short_description" class="form-label ">{{
                                                            ___('common.Short Description') }}
                                                            <span class="fillable">*</span></label>
                                                        <textarea
                                                            class="form-control ot-textarea @error('short_description') is-invalid @enderror"
                                                            name="short_description" id="short_description" rows="5"
                                                            placeholder="{{ ___('placeholder.Enter Short Description') }}"><?= @$data['course']->short_description ?></textarea>
                                                    ...
                                                    <div class="col-lg-12 col-md-6 mb-3">
                                                        <label for="description" class="form-label ">{{
                                                            ...
                                                            <span class="fillable">*</span></label>
                                                        <textarea
                                                            class="form-control ckeditor-editor @error('description') is-invalid @enderror"
                                                            name="description" id="description" rows="5"
                                                            placeholder="{{ ___('placeholder.Enter Description') }}"><?= @$data['course']->description ?></textarea>
                                                        @error('description')
                                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                                    ...
                                                    <div class="col-lg-6 col-md-6 mb-3">
                                                        ...
                                                        <select
                                                            ...
                                                            <optgroup class="select2-result-selectable"
                                                                ...
                                                                @if (@$data['course']->course_category_id != $child->id
                                                                && $child->status_id == 1)
                                                                <option value="{{ $child->id }}" {{ @$data['course']->
                                                                    course_category_id == $child->id ? '
                                                                    selected="selected"' : '' }}>
                                                                    {{ $child->title }}</option>
                                                                @elseif (@$data['course']->course_category_id ==
                                                                $child->id)
                                                                <option value="{{ $child->id }}" {{ @$data['course']->
                                                                    course_category_id == $child->id ? '
                                                                    selected="selected"' : '' }}>
                                                    ...
                                                    {{-- start visibility --}}
                                                    <div class="col-lg-6 col-md-6 mb-3">
                                                        <label for="visibility_id" class="form-label ">{{
                                                            ___('common.Visibility') }}<span
                                                                class="fillable">*</span></label>
                                                        <select
                                                            ...
                                                            <option value="{{ $visibility->id }}" {{ @$data['course']->
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="requirements" class="form-label ">{{
                                                            ___('course.Course Requirements') }}
                                                        </label>
                                                        <textarea
                                                            class="form-control ckeditor-editor @error('requirements') is-invalid @enderror"
                                                            name="requirements" id="requirements"
                                                            rows="5"><?= @$data['course']->requirements ?></textarea>
                                                    ...
                                                    {{-- start Requirements --}}
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="outcomes" class="form-label ">{{ ___('course.Course
                                                            Outcomes') }}
                                                        </label>

                                                        <textarea
                                                            class="form-control ckeditor-editor @error('outcomes') is-invalid @enderror"
                                                            name="outcomes" id="requirements"
                                                            rows="5"><?= @$data['course']->outcomes ?></textarea>
                                                        @error('outcomes')
                                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                            ...
                                            <div class="mb-24 border-0 pt-0">
                                                ...
                                                <div class="row">
                                                        ...
                                                        <div class="input-check-radio">
                                                            <div class="form-check">
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    @$data['course']->is_free == 1 ? '
                                                                checked="checked"' : '' }}
                                                                name="is_free">
                                                                <label class="form-check-label" for="is_free_course">{{
                                                                    ___('course.Is it free course') }}</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    {{-- <div
                                                        ...
                                                        <label for="price" class="form-label ">{{ ___('course.Course
                                                            Price') }}
                                                        </label>
                                                        <input
                                                            class="form-control ot-input @error('title') is-invalid @enderror"
                                                            name="price" list="datalistOptions" id="price" min="0"
                                                            type="number" value="{{ @$data['course']->price }}"
                                                        ...
                                                        <div class="input-check-radio">
                                                            <div
                                                                ...
                                                                <input class="form-check-input" type="checkbox"
                                                                    ...
                                                                    @$data['course']->is_discount == 11 ? '
                                                                checked="checked"' : '' }}
                                                                name="is_discount">
                                                                <label class="form-check-label" for="is_discount">{{
                                                                    ___('course.Check discount price') }}</label>
                                                            </div>
                                                        </div>
                                                    </div> --}}
                                                    ...
                                                    {{-- <div
                                                        ...
                                                        <select
                                                            ...
                                                            <option value="1" {{ $data['course']->discount_type == 1 ?
                                                                'selected' : '' }}>
                                                                {{ ___('course.Fixed') }}</option>
                                                            <option value="2" {{ $data['course']->discount_type == 2 ?
                                                                'selected' : '' }}>
                                        ...
                                        <div class="multiStep-wrapper-contents step4 ">
                                            ...
                                            <div class="mb-24 border-0 pt-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="course_preview" class="form-label ">{{
                                                            ___('course.Course Preview Type') }}
                                                        </label>
                                                        <select
                                                            class="form-control select2 ot-input @error('title') is-invalid @enderror"
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3 video_url">
                                                        <label for="video_url" class="form-label ">{{ ___('course.Video
                                                            URL') }}
                                                        </label>
                                                        <input
                                                            class="form-control ot-input @error('title') is-invalid @enderror"
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="thumbnail" class="form-label ">{{
                                                            ___('course.Thumbnail') }}
                                                            <span class="fillable">*</span>
                                                        </label>
                                                        <div @if (@$data['course']->thumbnailImage) data-val="{{
                                                            showImage(@$data['course']->thumbnailImage->original) }}"
                                                            @endif
                                                            data-name="thumbnail"
                                                            class="file @error('thumbnail') is-invalid @enderror"
                                                            data-height="200px "></div>
                                                        <small class="text-muted">{{ ___('placeholder.NB : Thumbnail
                                                            size will 600px x 600px and not more than 1mb') }}</small>
                                                        @error('thumbnail')
                                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
                                        ...
                                        <div class="multiStep-wrapper-contents step5 ">
                                            ...
                                            <div class="mb-24 border-0 pt-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    {{-- start meta title --}}
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="meta_title" class="form-label ">{{ ___('course.Meta
                                                            Title') }}
                                                        </label>
                                                        <input
                                                            class="form-control ot-input @error('title') is-invalid @enderror"
                                                    ...
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="meta_description" class="form-label ">{{
                                                            ___('course.Meta Description') }}
                                                        </label>
                                                        <textarea
                                                            class="form-control @error('title') is-invalid @enderror"
                                                            name="meta_description" list="datalistOptions" row="10"
                                                            id="meta_description"
                                                    ...
                                                    {{-- start thumbnail url --}}
                                                    <div class="col-xl-12 col-md-6 mb-3">
                                                        <label for="meta_image" class="form-label ">{{ ___('course.Meta
                                                            Image') }}
                                                        </label>
                                                        <div @if (@$data['course']->metaImage) data-val="{{
                                                            showImage(@$data['course']->metaImage->original) }}" @endif
                                                            data-name="meta_image"
                                                            class="file @error('meta_image') is-invalid @enderror"
                                                            data-height="200px "></div>
                                                        <small class="text-muted">{{ ___('placeholder.NB : Meta image
                                                            size will 1200px x 627px and not more than 1mb') }}</small>
                                                        @error('meta_image')
                                                        <div id="validationServer04Feedback" class="invalid-feedback">
                                                            {{ $message }}
                                                        </div>
