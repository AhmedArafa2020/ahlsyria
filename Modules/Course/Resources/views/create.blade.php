                        ...
                        <form action="{{ route('course.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="multiStep-wrapper-flex">
                                    ...
                                    <div class="mb-24 border-0 pt-0">
                                        <div class="row">
                                            ...
                                            <div class="col-xl-6 col-md-6 mb-3">
                                                <label for="title" class="form-label ">{{ ___('course.Course Title') }}
                                            ...
                                            <div class="col-xl-4 col-md-12 mb-3">
                                                <label for="course_type" class="form-label ">{{ ___('label.Course Type')
                                                    }}
                                                    <span class="fillable">*</span></label>
                                                <select
                                                    ...
                                                    <option value="{{ $type->id }}" {{ old('course_type')==$type->id ? '
                                                        selected="selected"' : '' }}>
                                                        {{ $type->name }}
                                                    </option>
                                                    @endforeach
                                            ...
                                            {{-- start cinstructor --}}
                                            <div class="col-xl-4 col-md-12 mb-3">
                                                <label for="instructor" class="form-label ">{{ ___('common.Instructor')
                                                    }}
                                                    <span class="fillable">*</span></label>
                                                <select
                                                    ...
                                                    <option selected="" disabled="" value="">
                                                        ...
                                                        <input
                                                            ...
                                                            id="instructor_name" value="{{ old('instructor_name') }}"
                                            ...
                                            <div class="col-xl-4 col-md-12 mb-3">
                                                ...
                                                <select
                                                    ...
                                                    <option value="{{ $level->id }}" {{ old('course_level')==$level->id
                                                        ? ' selected="selected"' : '' }}>
                                                        {{ $level->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-xl-12 col-md-12 mb-3">
                                                <label for="short_description" class="form-label ">{{ ___('label.Short
                                                    description') }}</label>
                                                <textarea
                                                    ...
                                                    placeholder="{{ ___('placeholder.Enter Short Description') }}">{{ old('short_description') }}</textarea>
                                            ...
                                            <div class="col-xl-12 col-md-12 mb-3">
                                                ...
                                                <textarea
                                                    ...
                                                    placeholder="{{ ___('placeholder.Enter Description') }}">{{ old('description') }}</textarea>
                                                @error('description')
                                                <div id="validationServer04Feedback" class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                            ...
                                            <div class="col-xl-3 col-md-6 mb-3">
                                                <label for="category_id" class="form-label ">{{ ___('label.Category') }}
                                                    <span class="fillable">*</span></label>
                                                <select
                                                    ...
                                                    <optgroup class="select2-result-selectable"
                                                        ...
                                                        <option value="{{ $child->id }}" {{ old('category')==$category->
                                            ...
                                            <div class="col-xl-3 col-md-6 mb-3">
                                                <label for="visibility_id" class="form-label ">{{
                                                    ___('label.Visibility') }}<span class="fillable">*</span></label>
                                                <select
                                            ...
                                            {{-- start language --}}
                                            <div class="col-xl-3 col-md-6 mb-3">
                                                <label for="language" class="form-label ">{{ ___('common.Language')
                                                    }}<span class="fillable">*</span></label>
                                                <select
                                    ...
                                    <div class="mb-24 border-0 pt-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="requirements" class="form-label ">{{ ___('label.Course
                                                    Requirements') }}
                                                </label>
                                                <textarea
                                                    class="form-control ckeditor-editor @error('requirements') is-invalid @enderror"
                                                    name="requirements" id="requirements" rows="5">
                                                            {{ old('requirements') }}
                                                        </textarea>
                                            ...
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                ...
                                                <textarea
                                                    ...
                                                    name="outcomes" id="requirements" rows="5">
                                                            {{ old('outcomes') }}
                                                        </textarea>
                                                @error('outcomes')
                                                <div id="validationServer04Feedback" class="invalid-feedback">
                                    ...
                                    <div class="mb-24 border-0 pt-0">
                                        ...
                                        <div class="row">
                                                ...
                                                <div class="input-check-radio">
                                                    <div class="form-check">
                                                        <input class="form-check-input" type="checkbox" value="1"
                                                            id="is_free_course" {{ old('is_free') ? 'checked'
                                                            : 'checked' }} name="is_free" disabled>
                                                        <label class="form-check-label" for="is_free_course">{{
                                                            ___('label.Is it free course') }}</label>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            {{-- <div class="col-xl-12 col-md-6 mb-3 price_div">
                                                <label for="price" class="form-label ">{{ ___('label.Course Price') }}
                                                </label>
                                                <input
                                                    class="form-control ot-input @error('title') is-invalid @enderror"
                                                    name="price" list="datalistOptions" id="price" min="0" type="number"
                                                ...
                                                <div class="input-check-radio">
                                                    <div class="form-check price_div">
                                                        ...
                                                        <label class="form-check-label" for="is_discount">{{
                                                            ___('label.Check discount price') }}</label>
                                                    </div>
                                                </div>
                                            </div> --}}
                                            ...
                                            {{-- <div class="col-xl-6 col-md-6 mb-3 price_div">
                                                <label for="discount_price" class="form-label ">{{ ___('label.Course
                                                    Discount') }}
                                                </label>
                                                <input
                                                    class="form-control ot-input @error('title') is-invalid @enderror"
                                            ...
                                            {{-- start discount type --}}
                                            {{-- <div class="col-xl-6 col-md-6 mb-3 price_div">
                                                <label for="discount_type" class="form-label ">{{ ___('label.Discount
                                                    Type') }}
                                                </label>
                                ...
                                <div class="multiStep-wrapper-contents step4 ">
                                    ...
                                    <div class="mb-24 border-0 pt-0">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="course_preview" class="form-label ">{{ ___('label.Course
                                                    Preview Type') }}
                                                </label>
                                            ...
                                            <div class="col-xl-12 col-md-6 mb-3 video_url">
                                                <label for="video_url" class="form-label ">{{ ___('label.Video URL') }}
                                            ...
                                            {{-- start thumbnail url --}}
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="thumbnail" class="form-label ">{{ ___('label.Thumbnail') }}
                                                </label>
                                                <div data-name="thumbnail"
                                                    class="file @error('thumbnail') is-invalid @enderror"
                                                    data-height="200px "></div>
                                                <small class="text-muted">{{ ___('placeholder.NB : Thumbnail size will
                                                    600px x 600px and not more than 1mb') }}</small>
                                                @error('thumbnail')
                                                <div id="validationServer04Feedback" class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="multiStep-wrapper-contents step5 ">
                                    ...
                                    <div class="mb-24 border-0 pt-0">
                                        ...
                                        <div class="row">
                                            {{-- start meta title --}}
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="meta_title" class="form-label ">{{ ___('label.Meta Title')
                                                    }}
                                                </label>
                                            ...
                                            {{-- start meta keyword --}}
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="meta_keyword" class="form-label ">{{ ___('label.Meta
                                                    Keyword') }}
                                                </label>
                                            ...
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="meta_description" class="form-label ">{{ ___('label.Meta
                                                    Description') }}
                                                </label>
                                                <textarea class="form-control" name="meta_description"
                                                    list="datalistOptions" row="10" id="meta_description"
                                            ...
                                            {{-- start thumbnail url --}}
                                            <div class="col-xl-12 col-md-6 mb-3">
                                                <label for="price" class="form-label ">{{ ___('course.Meta Image') }}
                                                </label>
                                                <div data-name="meta_image"
                                                    class="file @error('meta_image') is-invalid @enderror"
                                                    data-height="200px "></div>
                                                <small class="text-muted">{{ ___('placeholder.NB : Meta image size will
                                                    1200px x 627px and not more than 1mb') }}</small>
                                                @error('meta_image')
                                                <div id="validationServer04Feedback" class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
                                ...
                                <div class="multiStep-wrapper-contents text-center step6 ">
                                    ...
                                    <button type="submit" class="btn btn-lg ot-btn-primary">{{ ___('common.Submit')
                                        }}</button>
                                </div>
                                <!-- End complete form -->
                            </div>
                        ...
                        <div class="multiStep-footer-flex ml-14 mr-14">
                            <div class="multiStep-footer-left">
                                <a href="javascript:void(0)"
                                    class="multiStep-footer-back previous ot-btn-primary ot-primary-btn" id="previous">
                                    {{ ___('course.Back') }} </a>
                            </div>
                            <div class="multiStep-footer-right">
                                <a href="javascript:void(0)"
                                    class="multiStep-footer-next next ot-btn-primary btn-primary-fill" id="next">{{
                                    ___('course.Next') }} </a>
                            </div>
                        </div>
                    </div>
