...
class CourseRepository implements CourseInterface
{
    ...
    public function store($request)
    {
        ...
        try {
            ...
            $courseModel->cert_title = $request->cert_title;
            ...
            $courseModel->instructor_name = $request->instructor_name;
            $courseModel->is_free = $request->is_free ?? 1;
            ...
            $courseModel->created_by = $request->instructor ?? auth()->user()->id;
