                                ...
                                <div class="row justify-content-between">
                                    <div class="col-lg-12">
                                        <div class="ot-contact-form position-relative">
                                            ...
                                            <input class="tagify--outside border-0" type="text" placeholder="{{ ___('student.add social media link')}}"
                                                name="social_media_links" id="social_media_links"
                                                value="{{ @$data['student']->social_media_links ? json_encode(@$data['student']->social_media_links) : '' }}">
                                        </div>
                                    </div>
                                </div>
                            </div>
