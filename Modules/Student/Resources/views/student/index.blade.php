            ...
            <div class="card-body">
                ...
                <div
                    ...
                    <div class="align-self-center d-flex gap-2">
                        ...
                        <div class="align-self-center">
                            <a href="{{ route('admin.student.export') }}" role="button" class="btn-add"
                                data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="تصدير">
                                <span class="d-none d-xl-inline">تصدير CSV</span>
                            </a>
                        </div>
                    </div>
                    @endif
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody class="tbody">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div class="product-name ml-10">
                                            <div>{{ Str::limit(@$student->user->name, 20) }}</div>
                                            <div>{{ Str::limit(@$student->user->name_ar, 20) }}</div>
                                        </div>
                                    </div>
                                </td>
                                <td> {{ @$student->user->work_field }} </td>
                                ...
                                {{-- <td>
                                    {{ @$student->user != null ? statusBackend(@$student->user->userStatus->class,
                                ...
                                <td>
                                    @if(@$student->cv_file)
                                    <a class="downloada"
                                        href="{{env('APP_URL').'/storage/'.@$student->cv_file->original}}">تحميل</a>
                                    @endif
                                </td>
