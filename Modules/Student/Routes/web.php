...
Route::prefix('admin')->middleware(['auth.routes'])->group(function () {
    Route::prefix('student')->group(function () {
        Route::controller(StudentController::class)->group(function () {
            ...
            Route::get('/newsletter/{id?}', 'newsletter')->name('admin.newsletter.index')->middleware('PermissionCheck:student_list');
            Route::post('/newsletter', 'saveNewsletter')->name('admin.newsletter.save')->middleware('PermissionCheck:student_list');
            Route::get('/export', 'export')->name('admin.student.export')->middleware('PermissionCheck:student_list');
        ...
        Route::controller(SocialMediaLinkController::class)->group(function () {
            Route::get('add-social/{id}', 'addSkill')->name('admin.student.add.social');
            Route::post('store-social/{id}', 'storeSkill')->name('admin.student.store.social');
        });
    });
});
