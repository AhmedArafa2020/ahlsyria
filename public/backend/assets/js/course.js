(function ($) {
    ...
    let generalValidation = () => {
        ...
        if (!validateInput(title) || !validateInput(course_level) || !validateSelect2(category) || !validateInput(language)) {
            return false;
        }
        return true;
    }
    ...
    let mediaValidation = () => {
        ...
        if (!validateSelect2(course_preview) || (course_preview.value != 24)) {
            return false;
        }
        return true;
    }
