    ...
    <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-3 row-cols-xl-3 row-cols-xxl-5 g-24 mt-0 p-0 ">
        ...
        <div class="col">
            <div class="my-single-courses white-bg position-relative radius-8 h-calc">
                <a class="course-badge position-absolute text-10 font-400 radius-4 " href="javascript:void(0)">{{
                    @$enroll->course->category->title }}</a>
                <div class="video-img2 overly1">
                    <a href="javascript:void(0)"> <img src="{{ showImage(@$enroll->course->thumbnailImage->original) }}"
                ...
                <div class="course-caption">
                    ...
                    <span class="module-time d-block mb-6">{{ $enroll->course->lessons->count() }}
                        {{ ___('frontend.Lesson') }},
                        {{ minutes_to_hours(@$enroll->course->lessons()->where('is_quiz',0)->sum('duration')) }}</span>
