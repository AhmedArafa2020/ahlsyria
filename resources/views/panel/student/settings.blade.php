    ...
    <div class="row">
        ...
        <div class="col-xl-12">
            ...
            <ul class="nav course-details-tabs setting-tab mb-40" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="social">
                    <a href="{{ route('student.setting', ['social']) }}"
                        class="nav-link {{ url()->current() === route('student.setting', ['social']) ? 'active' : '' }} "
                        type="button" role="tab">
            ...
            <div class="tab-content" id="myTabContent">
                            ...
                            <div class="row">
                                <div class="col-xl-6 col-lg-12">
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        <label class="ot-contact-label">الاسم بالانجليزية <span
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        <label class="ot-contact-label">الاسم بالعربية <span
                                                class="text-danger">*</span></label>
                                        <input class="form-control ot-contact-input @error('name_ar') is-invalid @enderror"
                                            type="text" name="name_ar" placeholder="الاسم بالعربي" value="{{ auth()->user()->name_ar }}"
                                            >
                                        @error('name_ar')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        ...
                                        <div class="d-flex">
                                            ...
                                            <input class="form-control w-25" name="phone_dial" type="text"
                                                placeholder="0090"
                                                 value="{{ auth()->user()->phone_dial ?? '' }}"
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        <label class="ot-contact-label">{{ ___('student.Country') }} <span
                                                class="text-danger">*</span></label>
                                        <!-- Select2 -->
                                        {{-- <select class="country_list @error('country') is-invalid @enderror"
                                            name="country_id">
                                        ...
                                        <select id="countries_options" class="form-select select_2  ot-contact-input" name="country" aria-label="Default select example">
                                        @if(auth()->user()->country)
                                        <option value="{{auth()->user()->country}}" selected>{{auth()->user()->country}}</option>
                                        @endif
                                            <option value="{{null}}">{{ ___('student.Select Country') }}</option>
                                        </select>
                                        @error('country')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        <label class="ot-contact-label">{{ ___('student.state') }} <span
                                                class="text-danger">*</span></label>
                                        <!-- Select2 -->
                                        {{-- <select class="country_list @error('country') is-invalid @enderror"
                                            name="country_id">
                                            <option value="">{{ ___('placeholder.Select State') }}</option>
                                            @if (@$data['student']->country_id)
                                                <option value="{{ @$data['student']->country_id }}" selected>
                                                    {{ @$data['student']->country->name }}</option>
                                            @endif
                                        </select> --}}
                                        <select id="states_options" class="form-select select_2  ot-contact-input" name="state" aria-label="Default select example">
                                            @if(auth()->user()->state)
                                            <option value="{{auth()->user()->state}}" selected>{{auth()->user()->state}}</option>
                                            @endif
                                            <option value="{{null}}">{{ ___('student.Select State') }}</option>
                                        </select>
                                        @error('state')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="ot-contact-form mb-24">
                                        ...
                                        <select class="form-select  ot-contact-input" name="nationality" aria-label="Default select example">
                                            <option value="{{null}}">{{ ___('student.Select Nationality') }}</option>
                                            <option value="syrian" @if(auth()->user()->nationality == 'syrian') selected @endif>{{ ___('student.Syrian') }}</option>
                                            <option value="other" @if(auth()->user()->nationality == 'other') selected @endif>{{ ___('student.Other') }}</option>
                                        </select>
                                        @error('nationality')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-xl-6 col-lg-12">
                                    ...
                                    <div class="position-relative ot-contact-form mb-24">
                                        ...
                                        <select class="form-select  ot-contact-input" name="education" aria-label="Default select example">
                                            <option value="{{null}}">{{ ___('student.Select Education') }}</option>
                                            <option value="primary_school" @if(auth()->user()->education == 'primary_school') selected @endif>{{ ___('student.Primary School') }}</option>
                                            <option value="middle_school" @if(auth()->user()->education == 'middle_school') selected @endif>{{ ___('student.Middle School') }}</option>
                                            <option value="high_school" @if(auth()->user()->education == 'high_school') selected @endif>{{ ___('student.High School') }}</option>
                                            <option value="institute" @if(auth()->user()->education == 'institute') selected @endif>{{ ___('student.Institute') }}</option>
                                            <option value="university" @if(auth()->user()->education == 'university') selected @endif>{{ ___('student.University') }}</option>
                                            <option value="higher_education" @if(auth()->user()->education == 'higher_education') selected @endif>{{ ___('student.Higher Education') }}</option>
                                        </select>
                                        @error('education')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="position-relative ot-contact-form mb-24">
                                        ...
                                        <select id="work_field_select" class="form-select  ot-contact-input" name="work_field" aria-label="Default select example">
                                            <option value="{{null}}">{{ ___('student.Select Work Field') }}</option>
                                            <option value="Content Creator" @if(auth()->user()->work_field == 'Content Creator') selected @endif>{{ ___('student.Content Creator') }}</option>
                                            <option value="Web Programming" @if(auth()->user()->work_field == 'Web Programming') selected @endif>{{ ___('student.Web Programming') }}</option>
                                            <option value="Graphic Design" @if(auth()->user()->work_field == 'Graphic Design') selected @endif>{{ ___('student.Graphic Design') }}</option>
                                            <option value="other" @if(auth()->user()->work_field == 'other') selected @endif>{{ ___('student.Other') }}</option>
                                        </select>
                                        @error('work_field')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="position-relative ot-contact-form mb-24">
                                        ...
                                        <input class="form-control" name="experience_years" type="number" value="{{ auth()->user()->experience_years ?? old('experience_years') }}" min="1"
                                            placeholder="{{ ___('student.Enter Experience Years') }}" aria-label="default input example">
                                    ...
                                    <div class="position-relative ot-contact-form mb-24">
                                        <label for="exampleInputEmail1" class="ot-contact-label">
                                            {{ ___('student.Have You Worked As Freelancer Before?') }}
                                            <span class="text-danger">*</span>
                                        </label>
                                        <select id="freelancer_select" class="form-select  ot-contact-input" name="freelancer" aria-label="Default select example">
                                            <option value="{{null}}">{{ ___('student.Select') }}</option>
                                            <option value="1" @if(auth()->user()->freelancer == 1) selected @endif>{{ ___('student.Yes') }}</option>
                                            <option value="0" @if(auth()->user()->freelancer == 0) selected @endif>{{ ___('student.No') }}</option>
                                        </select>
                                        <div id="freelancer_years">
                                            ...
                                            <input class="form-control" name="freelancer_years" type="number" value="1" min="1"
                                                placeholder="{{ ___('student.Enter Freelancer Years') }}" aria-label="default input example">
                                        </div>
                                        @error('error_freelancer_years')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        @enderror
                                        @error('error_freelancer')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                        @enderror
                                    ...
                                    <!-- cv file -->
                                    <div class="ot-contact-form mb-24">
                                        <label class="ot-contact-label">CV File</label>
                                        @if(@$data['student']->cv_file)
                                        <div>
                                            <a href="{{env('APP_URL').'/storage/'.@$data['student']->cv_file->original}}">Uploaded CV</a>
                                        </div>
                                        @endif
                                        <input
                                            class="form-control ot-contact-input @error('cv_file') is-invalid @enderror"
                                            type="file" name="cv_file"
                                            value="{{ @$data['student']->cv_file ?? old('cv_file') }}">
                                        @error('cv_file')
                                            <div id="validationServer04Feedback" class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="position-relative ot-contact-form mb-24">
                                        <div class="remember-me terms-condition mb-0">
                                            <label>
                                                <input class="ot-checkbox" type="checkbox" value="1" name="newsletter" @if(auth()->user()->newsletter) checked @endif />
                                                <span>{{ ___('student.Subscribe to news letter') }}
                                                </span>
                ...
                @elseif (url()->current() === route('student.setting', ['social']))
                    <!-- Social -->
                    <div class="tab-pane fade show active">
                        <div class="row">
                            <div class="col-xl-12">
                                ...
                                <div class="col-xl-12">
                                    <div
                                        ...
                                        <button class="btn-primary-outline"
                                            onclick="mainModalOpen(`{{ route('student.add.social') }}`)"><i
                                                class="ri-add-line"></i> {{ ___('student.add new') }}</button>
                                    </div>
                                </div>
                                <!-- add -->
...
@section('scripts')
    ...
    fetch("{{ asset('frontend/assets/countries.json') }}")
    ...
    $('#countries_options').on('select2:select', function (e) {
        ...
        fetch("{{ asset('frontend/assets/states.json') }}")
            .then(response => response.json())
            .then(data2 => {
