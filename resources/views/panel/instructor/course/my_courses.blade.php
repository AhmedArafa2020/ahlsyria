            ...
            <div class="my-single-courses white-bg position-relative radius-8 h-calc">
                ...
                <div class="video-img2 overly1">
                    <a href="{{ route('frontend.courseDetails', $course->slug) }}">
                        <img src="{{ showImage(@$course->thumbnailImage->original) }}" class="img-cover" alt="img"> </a>
                    <!--Edit DropDown -->
                ...
                <div class="course-caption">
                    <h4>
                        <a href="{{ route('frontend.courseDetails', $course->slug) }}"
                            class="title colorEffect font-600 d-block line-clamp-2  mb-10">{{
                            Str::limit(@$course->title, 25) }}</a>
                    </h4>
