        ...
        <div class="col-xl-3 col-sm-6">
            <div class="single-dashboard-card carts-bg-four h-calc d-flex align-items-center">
                ...
                <div class="cat-caption">
                    ...
                    <div class="single-counter mb-15">
                        <p class="currency">
                            {{-- {{ shorten_number(@$data['instructor']->user->courseEnroll->groupBy('user_id')->count()
                            ?? 0) }} --}}
                        </p>
                    </div>
                </div>
        ...
        <div class="col-xl-12">
            <div class="ot-card mb-24">
                <div class="section-tittle-two mb-10 d-flex align-items-center justify-content-between flex-wrap">
                    ...
                    <a href="{{ route('instructor.course_reviews') }}" class="browse-btn mt-6">{{ ___('instructor.See
                        All') }}</a>
                </div>
    ...
    <div class="activity-wrapper ot-card white-bg">
        <div class="col-xl-12">
            <div class="section-tittle-two mb-10 d-flex align-items-center justify-content-between flex-wrap">
                ...
                <a href="{{ route('instructor.course_sales') }}" class="browse-btn mt-6">{{ ___('instructor.See All')
                    }}</a>
            </div>
        </div>
        <div class="row">
