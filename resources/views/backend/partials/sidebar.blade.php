<aside class="sidebar" id="sidebar">
    <div class="sidebar-header">
        <div class="sidebar-logo">
            ...
            <a href="{{ route('dashboard') }}">
              <!-- Light Theme Logo -->
              <img id="lightLogo" class="full-logo setting-image" src="{{ showImage(setting('light_logo'), 'dark-logo.svg') }}" alt="Light Logo" />
              <!-- Dark Theme Logo -->
              <img id="darkLogo" class="full-logo setting-image" src="{{ showImage(setting('dark_logo'), 'light-logo.svg') }}" alt="Dark Logo" style="display: none;" />
          </a>
        ...
        <div class="sidebar-menu-section">
            ...
            <ul class="sidebar-dropdown-menu parent-menu-list">
                ...
                @if (hasPermission('event_read'))
                    <li class="sidebar-menu-item {{ set_menu(['events.index']) }}">
                        <a href="{{ route('events.index') }}" class="parent-item-content">
                            <i class="las la-calendar-check"></i>
                            <span class="on-half-expanded">{{ ___('backend_sidebar.Events') }}</span>
                        </a>
                    </li>
                @endif
                ...
                {{-- start Events --}}
                @if (hasPermission('mentoring_read'))
                    <li class="sidebar-menu-item {{ set_menu(['mentorings.index']) }}">
                        <a href="{{ route('mentorings.index') }}" class="parent-item-content">
                            <i class="las la-calendar-check"></i>
                            <span class="on-half-expanded">{{ ___('backend_sidebar.mentorings') }}</span>
                        </a>
                    </li>
                @endif
                {{-- end Events --}}
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="child-menu-list">
                        ...
                        <li class="sidebar-menu-item {{ set_menu(['admin.instructor.requests']) }}">
                            <a href="{{ route('admin.instructor.requests') }}">{{ ___('backend_sidebar.Requested
                                Instructor') }}</a>
                        </li>
                        @endif
                        @if (hasPermission('instructor_suspend_list'))
                        <li class="sidebar-menu-item {{ set_menu(['admin.instructor.suspends']) }}">
                            <a href="{{ route('admin.instructor.suspends') }}">{{ ___('backend_sidebar.Suspended
                                Instructor') }}</a>
                        </li>
                        @endif
                        ...
                        <li
                            ...
                            <a href="{{ route('admin.instructor.index') }}">{{ ___('backend_sidebar.Instructor List')
                                }}</a>
                        </li>
                        @endif
                        ...
                        <li class="sidebar-menu-item {{ set_menu(['admin.instructor.create']) }}">
                            <a href="{{ route('admin.instructor.create') }}">{{ ___('backend_sidebar.Create Instructor')
                                }}</a>
                        </li>
                        @endif
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="child-menu-list">
                            @if (hasPermission('student_list'))
                                ...
                                <li class="sidebar-menu-item {{ set_menu(['admin.newsletter.index']) }}">
                                    <a
                                        href="{{ route('admin.newsletter.index') }}">{{ ___('backend_sidebar.Student Bulk Email') }}</a>
                                </li>
                            @endif
                ...
                {{-- start Payouts --}}
                {{-- @if (hasPermission('instructor_payout_request_list') || hasPermission('instructor_payout_list') || hasPermission('instructor_rejected_payout_list') || hasPermission('instructor_unpaid_payout_list'))
                ...
                <li class="sidebar-menu-item">
                    ...
                    <ul class="child-menu-list">
                        ...
                        <li
                            ...
                            <a href="{{ route('admin.instructor.payout.index') }}">{{ ___('instructor.Payouts List')
                                }}</a>
                        </li>
                        @endif
                ...
                {{-- end Payouts --}}
                {{-- start Accounts --}}
                {{-- @if (hasPermission('income_list') || hasPermission('account_list') || hasPermission('transaction_list') || hasPermission('expense_list'))
                ...
                @if (hasPermission('contact_read'))
                    ...
                    <li class="sidebar-menu-item">
                        <a class="parent-item-content has-arrow">
                            ...
                            <span class="on-half-expanded">تواصل معنا</span>
                        </a>
                        ...
                        <ul class="child-menu-list">
                            @if (hasPermission('contact_read'))
                                <li
                                    ...
                                    <a href="{{ route('admin.contacts.index') }}">الرسائل</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                    <li class="sidebar-menu-item">
                        <a class="parent-item-content has-arrow">
                            <i class="lar la-address-book"></i>
                            <span class="on-half-expanded">الملاحظات</span>
                        </a>

                        <!-- second layer child menu list start  -->
                        <ul class="child-menu-list">
                            @if (hasPermission('contact_read'))
                                <li class="sidebar-menu-item {{ set_menu(['admin.notes.index', 'admin/notes/*']) }}">
                                    <a href="{{ route('admin.notes.index') }}">الرسائل</a>
                                </li>
                            @endif
                        </ul>
                    </li>
                ...
                @if (hasPermission('featured_course_list') || hasPermission('discount_course_list'))
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <li class="sidebar-menu-item {{ set_menu(['admin.discount-course.index']) }}">
                            <a href="{{ route('admin.discount-course.index') }}">{{ ___('course.Discount Course List')
                                }}</a>
                        </li>
                        @endif --}}
                ...
                @if (hasPermission('report_student_engagement') ||
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <li class="sidebar-menu-item {{ set_menu(['report.admin_transaction']) }}">
                            <a href="{{ route('report.admin_transaction') }}">{{ ___('report.transaction') }}</a>
                        </li>
                        @endif --}}
                        </ul>
                    </li>
                ...
                @if (hasPermission('testimonial_read') || hasPermission('testimonial_create'))
                    ...
                    <li class="sidebar-menu-item">
                        ...
                        <ul class="child-menu-list">
                            @if (hasPermission('testimonial_read'))
                                <li class="sidebar-menu-item {{ set_menu(['admin.faq.index', 'admin/faq/edit/*']) }}">
                                    <a href="{{ route('admin.faq.index') }}">{{ ___('common.Faq List') }}</a>
                                </li>
                            @endif
                            @if (hasPermission('testimonial_create'))
                                <li class="sidebar-menu-item {{ set_menu(['admin.faq.create']) }}">
                                    <a href="{{ route('admin.faq.create') }}">{{ ___('common.Create Faq') }}</a>
                                </li>
                            @endif
                        ...
                        <ul class="child-menu-list">
                            ...
                            @if (hasPermission('blog_category_read'))
                                <li
                                    ...
                                    <a href="{{ route('blog-category.index') }}">{{ ___('blog.Blog Category') }}</a>
                                </li>
                            @endif
                            {{-- End blog category --}}
                        ...
                        <ul class="child-menu-list">
                            ...
                            @if (hasPermission('popular_course_category_list'))
                                <li class="sidebar-menu-item {{ set_menu(['course-category.popular']) }}">
                                    <a
                                        href="{{ route('course-category.popular') }}">{{ ___('backend_sidebar.Popular
                                                                        Categories') }}</a>
                                </li>
                            @endif
