    ...
    <div class="row g-4">
        ...
        <div class="col-12">
            <div class="row">
                <div class="dashboard-heading row align-items-center mt-6">
                    <div class="col-12 col-md-6 col-xl-6 col-lg-6">
                        <h3 class="title">احصائيات الطلاب</h3>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                    <div class="card summery-card ot-card h-100">
                        <div class="card-heading d-flex align-items-center">
                            ...
                            <div class="card-content">
                                <h4>صناع المحتوى</h4>
                                <h1>{{ $data['students_content_creator'] }}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                    <div class="card summery-card ot-card h-100">
                        <div class="card-heading d-flex align-items-center">
                            ...
                            <div class="card-content">
                                <h4>مبرمجين الويب</h4>
                                <h1>{{ $data['students_web_programming'] }}</h1>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 col-lg-3 col-xl-3">
                    <div class="card summery-card ot-card h-100">
                        <div class="card-heading d-flex align-items-center">
                            ...
                            <div class="card-content">
                                <h4>المصممون</h4>
                                <h1>{{ $data['students_graphic_design'] }}</h1>
                            </div>
                        </div>
                    </div>
                </div>
