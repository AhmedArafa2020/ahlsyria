   ...
   <section class="become-instructor pt-50 mb-100 section-bg-two" id="ot_become_an_instructor"
       @if (@$section->color) style="background:{{ @$section->color }}" @endif>
       <div class="container">
           <div class="row justify-content-between align-items-center">
               <div class="col-xxl-5 col-xl-5 col-lg-5 col-md-12 overflow-hidden">
                   <!-- about-img -->
                   <div class="about-img tilt-effect">
                       <img src="{{ showImage(gallery('tracking-certificate'), 'backend/uploads/default-images/become_instructor.png') }}"
                           class="w-100" alt="img">
                   </div>
               </div>
