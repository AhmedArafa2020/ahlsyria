<div class="course-widget radius-12 h-calc ">
    <div class="course-widget-img position-relative overflow-hidden">
        ...
        {{-- <a
            class="course-badge bg-{{ @$course->courseType->class }} position-absolute text-12 font-500 radius-4 d-inline-flex "
        ...
        <div class="bookmark-wrapper">
            ...
            @else
            <a href="javascript:void(0)" class="bookmark bookmark-added" data-id="{{ encryptFunction(@$course->id) }}">
    ...
    <div class="widget-mid w-100 ">
                ...
                <div class="d-flex align-items-center gap-20 mb-0 flex-wrap">
                    ...
                    <div class="d-flex align-items-center gap-5">
                        ...
                        <h5 class="text-12 font-400 text-gray">{{
                            minutes_to_hours(@$course->lessons()->where('is_quiz',0)->sum('duration')) }}
                        </h5>
                    </div>
                </div>
            </div>
        ...
        <p class="text-gray font-400  line-clamp-1">{{ @$course->instructor_name }}
        </p>
        @endif
        ...
        <div class="widget-footer">
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap mb-10">
                <a @if (@$course->firstLesson) href="{{ route('student.course.learn', [@$course->slug,
                    encryptFunction(@$course->firstLesson->id)]) }}"
                    @else
            ...
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                ...
                <button data-val="{{ encrypt($course->id) }}" class="btn-primary-outline mb-10 checkout2"><i
                        class="ri-shopping-cart-line"></i> {{
                    ___('frontend.Enroll') }} </button>
            </div>
            @endif
