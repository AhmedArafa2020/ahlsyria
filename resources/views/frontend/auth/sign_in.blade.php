                    ...
                    <div class="ot-login-card">
                        ...
                        @if (session('email_verify'))
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <strong>تم تأكيد البريد الالكتروني بنجاح</strong>
                                <button type="button" class="btn-close" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                        {{-- @else
                        <div class="title">
                            <h4>شكراً لك على القيام بالتسجيل على المنصة</h4>
                        </div> --}}
                        @endif
                        @if (session('danger'))
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <form action="{{ route('student.sign_in_post') }}" method="POST" id="studentSignIn">
                            ...
                            <div class="position-relative ot-contact-form">
                                <label for="exampleInputEmail1" class="ot-contact-label">
                            ...
                            <div class="d-grid">
                                <button type="button" class="btn-primary-submit btn-login mt-26"
                        ...
                        <div class="login-footer">
                            <div class="create-account">
                                <p>ليس لديك حساب؟
                                <a href="{{ route('student.sign_up') }}"><span class="mx-1">{{ ___('auth.Create an account') }}</span></a>
                                </p>
                            </div>
