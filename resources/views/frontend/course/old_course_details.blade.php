        ...
        <div class="row">
            <div class="col-xl-9 col-lg-8 col-md-12">
                <div class="video-section mb-60">
                    @if (@$data['course']->course_overview_type == 15 && ! empty(@$data['course']->video_url))
                    ...
                    @elseif (@$data['course']->course_overview_type == 16 && ! empty(@$data['course']->video_url))
                    <div class="container video-size">
                    ...
                    @elseif (@$data['course']->course_overview_type == 17 && ! empty(@$data['course']->video_url))
                    <video id="player" playsinline controls
                        data-poster="{{ showImage(@$data['course']->thumbnailImage->original) }}" playsinline controls>
                    ...
                    <div class="container video-size">
                        ...
                        {{-- <video id="player" controls>
                            <source
                                src="https://drive.google.com/uc?export=download&id={{course_video_url_preg_match(@$data['course']->video_url)}}"
                                type='video/webm'>
                        </video> --}}
                        <img src="{{ showImage(@$data['course']->thumbnailImage->original) }}" class="img-cover" alt="img">
                    </div>
                    @endif
                </div>
                <div class="ot-course-details-inner">
                    ...
                    <div class="d-flex course-author gap-12 align-items-center">
                        ...
                        {{-- <div class="author-info">
                            <p>{{ @$data['course']->instructor_name }}</p>
                        </div> --}}
                    </div>
                    <div class="d-flex gap-20 flex-wrap">
                        <div class="flex-fill">
                            ...
                            <div
                                ...
                                <h5>{{
                                    minutes_to_hours($data['course']->lessons()->where('is_quiz',0)->sum('duration'))
                                    }}</h5>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="Overview" role="tabpanel"
                            ...
                            <div class="course-tab-widget">
                                <h3 class="course-details-title">المدرب</h3>
                                <ul class="course-details-list">
                        ...
                        <div class="tab-pane fade" id="Forum" role="tabpanel" aria-labelledby="Forum-tab">
                            ...
                            <!-- course tab forum s t a r t  -->
                            <div class="course-tab-widget">
                                <?= $data['forum'] ?>
                            </div>
                            <!-- End-of course tab forum  -->
            ...
            <div class="col-xl-3 col-lg-4 col-md-8" id="course-summary" data-val="{{ encrypt(@$data['course']->id) }}">
                    ...
                    <div class="course-details-right-box-inner">
                        <div class="d-flex align-items-center">
                            <div class="current-prise d-flex align-items-center flex-fill">
                                ...
                                <h4>{{ ___('frontend.Free') }}</h4> <small class="ml-2 text-tertiary">({{
                                    ___('subscription.Package') }})</small>
                        ...
                        @if(auth()->user()->userCourseEnroll->where('course_id',
                        $data['course']->id)->where('approved',1)->count() > 0)
                        <a @if (@$data['course']->firstLesson) href="{{ route('student.course.learn',
                            [@$data['course']->slug, encryptFunction(@$data['course']->firstLesson->id)]) }}"
                            @else
                        ...
                        @else
                        <div class="border border-2 rounded-pill p-2 text-center">{{ ___('student.Pending Approval') }}
                        </div>
                        @endif
                        ...
                        <div class="course-features">
                            ...
                            <div class="course-feature-list d-flex align-items-center gap-14 ">
                                ...
                                <p>{{ minutes_to_hours($data['course']->lessons()->where('is_quiz',0)->sum('duration'))
                                    }}
                                    مدة التدريب</p>
                            </div>
                            <div class="course-feature-list d-flex align-items-center gap-14 ">
